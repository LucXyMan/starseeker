    ...
    def update(self):
        ...
        def __light_up():
            ...
            self._decoration = (
                ...
                (2 if self._area.right == self._whole_rect.right else 0) +
                (4 if self._area.bottom == self._whole_rect.bottom else 0) +
                (8 if self._area.left == 0 else 0))
...
class Icon(_Display):
    ...
    def cursor(self, value):
        u"""カーソル位置設定。
        """
        if self._is_active and not self._is_moving:
