...
class Item(Lottery):
    ...
    def _reload(self):
        ...
        for ticket, number in (
            ...
            self._box += [ticket]*(self.__CAPACITY/number)
            remaining -= self.__CAPACITY/number
        self._box += [self.BLANK_TICKET]*remaining
...
class Card(Lottery):
    ...
    def _reload(self):
        ...
        self._box += [self.BLANK_TICKET]*(self.__CAPACITY-len(self._box))
        _random.shuffle(self._box)
