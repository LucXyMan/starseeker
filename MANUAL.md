...
ゲームに勝つと一度だけ、SP（スター・ポイント）とカードを取得できます。
...
基本形ブロックには三段階の硬さがあり、ゲームが進行すると硬さが変化します。
...
- 画面下部
	- スター: 取得スターを表示。
	- PL: ピースレベル。高いほど複雑な形のピースが出現する。
	- H: 硬度。高いほど硬いブロックが出現する。
	- L: 幸運。高いほど上位ランクのキー・チェストが出現する。
- 画面端
...
- イレギュラー
	...
	- デーモン: ブロックを食べながら移動する。シャードを食って進化する。
	- ゴースト: 空白にイレギュラーを生成する。
...
- アイテム
	...
	- キー
		- ブロンズキー: 宝箱を開ける。壊れやすい。
		- シルバーキー: 宝箱を開ける。多少壊れにくい。
		- ゴールドキー: 宝箱を開ける。最も壊れにくい。
	- チェスト
		- アイアンチェスト: 鉄の宝箱。鍵は不要。
...
#### 宝箱の中身
- アイアンチェスト: 7種類のスターx1と4種類のパワーアップx1。
- ブロンズチェスト: 7種類のスターx2と4種類のパワーアップx2。
- シルバーチェスト: 7種類のスターx3と4種類のパワーアップx3。
- ゴールドチェスト: 7種類のスターx4と4種類のパワーアップx4。
